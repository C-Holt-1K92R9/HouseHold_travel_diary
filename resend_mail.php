...
if ($conn->query($insrt) === TRUE && $check['is_verified']==='1') {
    ...
    exit();}
        ...
        $verification_link = "https://hisctg.com/verify.php?token=$verification_token";
                ...
                <table width='100%' cellpadding='0' cellspacing='0'>
                    <tr>
                        <td style='padding: 20px; background-color: #f7f7f7; text-align: center;'>
                            ...
                            <a href='$verification_link' style='display: inline-block; padding: 12px 20px; background-color: #4CAF50; color: #fff; text-decoration: none; border-radius: 5px;'>Verify Email</a>
                            <p style='font-size: 14px; color: #777;'>If you did not sign up, please ignore this email.</p>
                        </td>
                    </tr>
                </table>
                <footer style='text-align: center; padding: 20px; background-color: #f7f7f7;'>
                    <p style='font-size: 12px;'>Best regards,</p>
                    <p style='font-size: 12px;'>The HISCtg Team</p>
                    <p style='font-size: 12px;'>For support, contact <a href='mailto:support@hisctg.com' style='color: #4CAF50;'>support@hisctg.com</a></p>
                </footer>
            </body>
            </html>
            ...
            // Headers for HTML email
            $headers = "From: noreply@hisctg.com" . "\r\n";
            $headers .= "Reply-To: support@hisctg.com" . "\r\n"; // Optional: Support email for responses
            $headers .= "MIME-Version: 1.0" . "\r\n";
            $headers .= "Content-Type: text/html; charset=UTF-8" . "\r\n";
            ...
            if (mail($email, $subject, $message, $headers)) {
                // Redirect to a success page
                header("Location: success.php?head=Complete Regintration. & msg=A verification link has been sent to your email. Follow that link to complete your registration.<br><span style='color:red;'>Note: See your spam folder incase it's filtered as spam mail.<span>");
                exit();
            } else {
                echo "Error sending email.";
            }
...
<body>
  <div class="login-container">
    ...
    <form id="loginForm" class="login-form" action="resend_mail.php" method="POST">
